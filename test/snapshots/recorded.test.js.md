...

    {
      error: GraphqlResponseError {
        ...
        request: {
          query: `␊
                mutation setItemProperties($projectId: ID!, $itemId: ID!) {␊
                  ␊
                    date: updateProjectV2ItemFieldValue(input: {projectId: $projectId, itemId: $itemId, fieldId: "PVTF_10", value: {date: "<invalid>"}}) {␊
                      projectV2Item { ␊
            id␊
            createdAt␊
            type␊
        ...
        message: `Request failed due to following response errors:␊
         - Argument 'date' on InputObject 'ProjectV2FieldValue' has an invalid value ("<invalid>"). Expected type 'Date'.`,
      },
    }
